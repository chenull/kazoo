...
-spec set_resp_header_fold({ne_binary(), any()}, kz_proplist()) -> kz_proplist().
...
-spec add_content_types_provided(context(), crossbar_content_handler() | crossbar_content_handlers()) -> context().
...
-spec add_content_types_accepted(context(), crossbar_content_handler() | crossbar_content_handlers()) -> context().
...
-spec validate_request_data(ne_binary() | api_object(), context(), after_fun()) -> context().
validate_request_data(SchemaId, Context, OnSuccess) ->
    validate_request_data(SchemaId, Context, OnSuccess, 'undefined').

-spec validate_request_data(ne_binary() | api_object(), context(), after_fun(), after_fun()) -> context().
...
-spec validate_request_data(ne_binary() | api_object(), context(), after_fun(), after_fun(), boolean()) -> context().
...
%% @end
%%--------------------------------------------------------------------
-spec add_validation_error(kz_json:path(), ne_binary(), ne_binary() | kz_json:object(), context()) -> context().
...
-spec maybe_fix_js_integer(kz_json:path(), kz_json:json_term(), kz_json:object()) -> kz_json:object().
...
-spec maybe_fix_js_boolean(kz_json:path(), kz_json:json_term(), kz_json:object()) -> kz_json:object().
