...
-type node_specific() :: kz_types:node() | kz_term:ne_binary().
...
get(Key, Default) ->
    get(Key, Default, kz_term:to_binary(kz_types:node())).
...
fetch(Key, Default) ->
    fetch(Key, Default, kz_term:to_binary(kz_types:node())).

fetch(Key, Default, 'undefined') ->
    fetch(Key, Default);
fetch(Key, Default, Timeout) when is_integer(Timeout) ->
    fetch(Key, Default, kz_term:to_binary(kz_types:node()), Timeout);
...
set(Key, Value) ->
    set(Key, Value, kz_term:to_binary(kz_types:node()), []).
...
set_node(Key, Value) ->
    set_node(Key, Value, kz_types:node()).
