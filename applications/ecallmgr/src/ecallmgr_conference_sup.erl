...
-spec start_conference_control(kz_types:node(), kz_term:ne_binary(), kz_term:ne_binary()) -> kz_types:sup_startchild_ret().
start_conference_control(Node, ConferenceId, InstanceId) ->
    supervisor:start_child(?SERVER, [Node, ConferenceId, InstanceId]).

-spec stop_conference_control(kz_types:node(), kz_term:ne_binary(), kz_term:ne_binary()) -> any().
