...
bind_to_q(Q, ['new_voicemail'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_VOICEMAIL_NEW),
    bind_to_q(Q, T);
bind_to_q(Q, ['voicemail_saved'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_VOICEMAIL_SAVED),
    bind_to_q(Q, T);
bind_to_q(Q, ['voicemail_full'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_VOICEMAIL_FULL),
    bind_to_q(Q, T);
bind_to_q(Q, ['inbound_fax'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_FAX_INBOUND),
    bind_to_q(Q, T);
bind_to_q(Q, ['outbound_fax'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_FAX_OUTBOUND),
    bind_to_q(Q, T);
...
bind_to_q(Q, ['inbound_fax_error'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_FAX_INBOUND_ERROR),
    bind_to_q(Q, T);
bind_to_q(Q, ['outbound_fax_error'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_FAX_OUTBOUND_ERROR),
    bind_to_q(Q, T);
bind_to_q(Q, ['outbound_smtp_fax_error'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_FAX_OUTBOUND_SMTP_ERROR),
    bind_to_q(Q, T);
...
bind_to_q(Q, ['register'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_REGISTER),
    bind_to_q(Q, T);
bind_to_q(Q, ['deregister'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_DEREGISTER),
    bind_to_q(Q, T);
bind_to_q(Q, ['password_recovery'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_PASSWORD_RECOVERY),
    bind_to_q(Q, T);
bind_to_q(Q, ['first_occurrence'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_FIRST_OCCURRENCE),
    bind_to_q(Q, T);
bind_to_q(Q, ['new_account'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_NEW_ACCOUNT),
    bind_to_q(Q, T);
bind_to_q(Q, ['account_zone_change'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_ACCOUNT_ZONE_CHANGE),
    bind_to_q(Q, T);
bind_to_q(Q, ['new_user'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_NEW_USER),
    bind_to_q(Q, T);
bind_to_q(Q, ['port_unconfirmed'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_PORT_UNCONFIRMED),
    bind_to_q(Q, T);
bind_to_q(Q, ['port_request'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_PORT_REQUEST),
    bind_to_q(Q, T);
bind_to_q(Q, ['port_pending'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_PORT_PENDING),
    bind_to_q(Q, T);
bind_to_q(Q, ['port_scheduled'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_PORT_SCHEDULED),
    bind_to_q(Q, T);
bind_to_q(Q, ['port_rejected'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_PORT_REJECTED),
    bind_to_q(Q, T);
bind_to_q(Q, ['port_cancel'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_PORT_CANCEL),
    bind_to_q(Q, T);
bind_to_q(Q, ['ported'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_PORTED),
    bind_to_q(Q, T);
bind_to_q(Q, ['port_comment'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_PORT_COMMENT),
    bind_to_q(Q, T);
bind_to_q(Q, ['cnam_requests'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_CNAM_REQUEST),
    bind_to_q(Q, T);
bind_to_q(Q, ['low_balance'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_LOW_BALANCE),
    bind_to_q(Q, T);
bind_to_q(Q, ['topup'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_TOPUP),
    bind_to_q(Q, T);
bind_to_q(Q, ['transaction'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_TRANSACTION),
    bind_to_q(Q, T);
bind_to_q(Q, ['system_alerts'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_SYSTEM_ALERT),
    bind_to_q(Q, T);
bind_to_q(Q, ['webhook'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_WEBHOOK_CALLFLOW),
    bind_to_q(Q, T);
bind_to_q(Q, ['webhook_disabled'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_WEBHOOK_DISABLED),
    bind_to_q(Q, T);
bind_to_q(Q, ['denied_emergency_bridge'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_DENIED_EMERGENCY_BRIDGE),
    bind_to_q(Q, T);
bind_to_q(Q, ['customer_update'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_CUSTOMER_UPDATE),
    bind_to_q(Q, T);
bind_to_q(Q, ['missed_call'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_MISSED_CALL),
    bind_to_q(Q, T);
bind_to_q(Q, ['skel'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_SKEL),
    bind_to_q(Q, T);
bind_to_q(Q, ['service_added'|T]) ->
    'ok' = kz_amqp_util:bind_q_to_notifications(Q, ?NOTIFY_SERVICE_ADDED),
    bind_to_q(Q, T);
bind_to_q(_Q, []) ->
    'ok'.
...
unbind_q_from(Q, ['new_voicemail'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_VOICEMAIL_NEW),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['voicemail_full'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_VOICEMAIL_FULL),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['inbound_fax'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q,?NOTIFY_FAX_INBOUND),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['outbound_fax'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q,?NOTIFY_FAX_OUTBOUND),
    unbind_q_from(Q, T);
...
unbind_q_from(Q, ['inbound_fax_error'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q,?NOTIFY_FAX_INBOUND_ERROR),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['outbound_fax_error'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q,?NOTIFY_FAX_OUTBOUND_ERROR),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['outbound_smtp_fax_error'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q,?NOTIFY_FAX_OUTBOUND_SMTP_ERROR),
    unbind_q_from(Q, T);
...
unbind_q_from(Q, ['register'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_REGISTER),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['deregister'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_DEREGISTER),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['password_recovery'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_PASSWORD_RECOVERY),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['first_occurrence'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_FIRST_OCCURRENCE),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['new_account'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_NEW_ACCOUNT),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['account_zone_change'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_ACCOUNT_ZONE_CHANGE),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['new_user'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_NEW_USER),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['port_unconfirmed'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_PORT_UNCONFIRMED),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['port_request'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_PORT_REQUEST),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['port_pending'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_PORT_PENDING),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['port_scheduled'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_PORT_SCHEDULED),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['port_rejected'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_PORT_REJECTED),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['port_cancel'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_PORT_CANCEL),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['ported'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_PORTED),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['port_comment'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_PORT_COMMENT),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['cnam_request'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_CNAM_REQUEST),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['low_balance'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_LOW_BALANCE),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['topup'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_TOPUP),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['transaction'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_TRANSACTION),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['system_alert'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_SYSTEM_ALERT),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['webhook'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_WEBHOOK_CALLFLOW),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['webhook_disabled'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_WEBHOOK_DISABLED),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['denied_emergency_bridge'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_DENIED_EMERGENCY_BRIDGE),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['customer_update'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_CUSTOMER_UPDATE),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['missed_call'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_MISSED_CALL),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['skel'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_SKEL),
    unbind_q_from(Q, T);
unbind_q_from(Q, ['service_added'|T]) ->
    'ok' = kz_amqp_util:unbind_q_from_notifications(Q, ?NOTIFY_SERVICE_ADDED),
    unbind_q_from(Q, T);
unbind_q_from(_Q, []) ->
    'ok'.
...
publish_voicemail_saved(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_VOICEMAIL_SAVED, Payload, ContentType).
...
publish_voicemail_new(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_VOICEMAIL_NEW, Payload, ContentType).
...
publish_voicemail_full(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_VOICEMAIL_FULL, Payload, ContentType).
...
publish_fax_inbound(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_FAX_INBOUND, Payload, ContentType).
...
publish_fax_outbound(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_FAX_OUTBOUND, Payload, ContentType).
...
publish_fax_inbound_error(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_FAX_INBOUND_ERROR, Payload, ContentType).
...
publish_fax_outbound_error(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_FAX_OUTBOUND_ERROR, Payload, ContentType).
...
publish_fax_outbound_smtp_error(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_FAX_OUTBOUND_SMTP_ERROR, Payload, ContentType).
...
publish_register(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_REGISTER, Payload, ContentType).
...
publish_deregister(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_DEREGISTER, Payload, ContentType).
...
publish_password_recovery(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_PASSWORD_RECOVERY, Payload, ContentType).
...
publish_first_occurrence(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_FIRST_OCCURRENCE, Payload, ContentType).
...
publish_new_account(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_NEW_ACCOUNT, Payload, ContentType).
...
publish_account_zone_change(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_ACCOUNT_ZONE_CHANGE, Payload, ContentType).
...
publish_new_user(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_NEW_USER, Payload, ContentType).
...
publish_port_unconfirmed(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_PORT_UNCONFIRMED, Payload, ContentType).
...
publish_port_request(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_PORT_REQUEST, Payload, ContentType).
...
publish_port_pending(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_PORT_PENDING, Payload, ContentType).
...
publish_port_scheduled(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_PORT_SCHEDULED, Payload, ContentType).
...
publish_port_rejected(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_PORT_REJECTED, Payload, ContentType).
...
publish_port_cancel(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_PORT_CANCEL, Payload, ContentType).
...
publish_ported(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_PORTED, Payload, ContentType).
...
publish_port_comment(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_PORT_COMMENT, Payload, ContentType).
...
publish_cnam_request(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_CNAM_REQUEST, Payload, ContentType).
...
publish_low_balance(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_LOW_BALANCE, Payload, ContentType).
...
publish_topup(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_TOPUP, Payload, ContentType).
...
publish_transaction(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_TRANSACTION, Payload, ContentType).
...
publish_service_added(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_SERVICE_ADDED, Payload, ContentType).
...
publish_system_alert(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_SYSTEM_ALERT, Payload, ContentType).
...
publish_webhook(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_WEBHOOK_CALLFLOW, Payload, ContentType).
...
publish_webhook_disabled(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_WEBHOOK_DISABLED, Payload, ContentType).
...
publish_denied_emergency_bridge(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_DENIED_EMERGENCY_BRIDGE, Payload, ContentType).
...
publish_customer_update(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_CUSTOMER_UPDATE, Payload, ContentType).
...
publish_missed_call(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_MISSED_CALL, Payload, ContentType).
...
publish_skel(API, ContentType) ->
    ...
    kz_amqp_util:notifications_publish(?NOTIFY_SKEL, Payload, ContentType).
